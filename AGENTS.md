...
- Conservative driving presentation consumes engine and projector output; SwiftUI cannot upgrade marker confidence, realtime passage, route-editing availability, surface occurrence identity, or Finish-drive exit selection. KR-U06, KR-U07, KR-U08, and KR-U12 execute this boundary through synthetic iPhone states only. The panel has no live `NavigationSession`, released road data, audio authority, or CarPlay scene.
