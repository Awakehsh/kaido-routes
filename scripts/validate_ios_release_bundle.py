...
C1_ROUTE_PLAN_ID = (
    ...
    "shuto.ic.c1.shiodome.x1.recommended"
)
...
# Generated by the existing DriveControlIntent and its two localized catalogs.
APP_INTENTS_ALLOWED_FILES = {
...
def validate_distribution_files(app: Path, repository_root: Path) -> None:
    ...
    allowed_files = FIXED_ALLOWED_FILES | APP_INTENTS_ALLOWED_FILES
