...
func valhallaProviderExecutesBoundedProtocol() async throws {
  ...
  let locations = try #require(routeJSON["locations"] as? [[String: Any]])
  #expect(locations.count == 2)
  #expect(locations[0]["heading"] == nil)
  #expect(locations[0]["node_snap_tolerance"] == nil)
  #expect(locations[1]["heading"] as? Int == 90)
  #expect(locations[1]["heading_tolerance"] as? Int == 10)
  #expect((locations[1]["node_snap_tolerance"] as? NSNumber)?.doubleValue == 0)
